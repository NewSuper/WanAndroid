(self["webpackChunkant_design_pro"] =
  ...
  \**********************************************/
      /***/ function(
        ...
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./utils */ "./node_modules/antd/es/badge/utils.js"
        );
        ...
        var Ribbon = function Ribbon(_ref) {
          ...
          var colorInPreset = (0,
          _utils__WEBPACK_IMPORTED_MODULE_5__.isPresetColor)(color);
          var ribbonCls = classnames__WEBPACK_IMPORTED_MODULE_3___default()(
            prefixCls,
            "".concat(prefixCls, "-placement-").concat(placement),
            ((_classNames = {}),
            (0,
            ...
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(
              _classNames,
              "".concat(prefixCls, "-color-").concat(color),
              colorInPreset
            ),
            _classNames),
            className
  ...
  \****************************************************/
      /***/ function(
        ...
        /* harmony import */ var _SingleNumber__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./SingleNumber */ "./node_modules/antd/es/badge/SingleNumber.js"
        );
          ...
          if (count && Number(count) % 1 === 0) {
            ...
            numberNodes = numberList.map(function(num, i) {
              return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                _SingleNumber__WEBPACK_IMPORTED_MODULE_4__.default,
                {
                  prefixCls: prefixCls,
                  count: Number(count),
          ...
          if (children) {
            ...
            _util_reactNode__WEBPACK_IMPORTED_MODULE_5__.cloneElement)(
              ...
              function(oriProps) {
                return {
                  className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
                    "".concat(prefixCls, "-custom-component"),
                    oriProps === null || oriProps === void 0
                      ? void 0
                      : oriProps.className,
                    motionClassName
                  )
          ...
          if (
            ...
            offsetStyle = {
              transform: "translateY(".concat(
                -getOffset(prevValue, value, unit),
                "00%)"
              )
            };
          }
  ...
  \*********************************************/
      /***/ function(
        ...
        /* harmony import */ var _ScrollNumber__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ./ScrollNumber */ "./node_modules/antd/es/badge/ScrollNumber.js"
        );
        /* harmony import */ var _Ribbon__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./Ribbon */ "./node_modules/antd/es/badge/Ribbon.js"
        );
        ...
        var Badge = function Badge(_a) {
          ...
          var numberedDisplayCount =
            count > overflowCount ? "".concat(overflowCount, "+") : count;
          var hasStatus =
          ...
          var isHidden = (0, react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(
            function() {
              var isEmpty =
                mergedCount === null ||
          ...
          var displayCountRef = (0, react__WEBPACK_IMPORTED_MODULE_3__.useRef)(
            mergedCount
          );
          ...
          var isDotRef = (0, react__WEBPACK_IMPORTED_MODULE_3__.useRef)(
            showAsDot
          );
          ...
          var mergedStyle = (0, react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(
            function() {
              if (!offset) {
                return (0,
          ...
          var titleNode =
            title !== null && title !== void 0
              ? title
              : typeof livingCount === "string" ||
                typeof livingCount === "number"
                ? livingCount
                : undefined; // >>> Status Text
          ...
          var displayNode =
            ...
            _babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__.default)(
              ...
              ? undefined
              : (0, _util_reactNode__WEBPACK_IMPORTED_MODULE_7__.cloneElement)(
                  livingCount,
                  function(oriProps) {
                    return {
                      style: (0,
          ...
          var statusCls = classnames__WEBPACK_IMPORTED_MODULE_5___default()(
            ((_classNames = {}),
            (0,
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
              _classNames,
              "".concat(prefixCls, "-status-dot"),
              hasStatus
            ),
            (0,
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
              _classNames,
              "".concat(prefixCls, "-status-").concat(status),
              !!status
            ),
            (0,
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
              _classNames,
              "".concat(prefixCls, "-status-").concat(color),
              (0, _utils__WEBPACK_IMPORTED_MODULE_8__.isPresetColor)(color)
            ),
            _classNames)
          );
          var statusStyle = {};
          ...
          var badgeClassName = classnames__WEBPACK_IMPORTED_MODULE_5___default()(
            ...
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
              _classNames2,
              "".concat(prefixCls, "-status"),
              hasStatus
            ),
            (0,
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
              _classNames2,
              "".concat(prefixCls, "-not-a-wrapper"),
              !children
            ),
            (0,
            _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
          ...
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_3__.createElement(
            ...
            /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_3__.createElement(
              ...
              function(_ref) {
                ...
                var scrollNumberPrefixCls = getPrefixCls(
                  "scroll-number",
                  customizeScrollNumberPrefixCls
                );
                var isDot = isDotRef.current;
                var scrollNumberCls = classnames__WEBPACK_IMPORTED_MODULE_5___default()(
                  ((_classNames3 = {}),
                  (0,
                  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
                    _classNames3,
                  ...
                  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
                    _classNames3,
                    "".concat(prefixCls, "-count"),
                    !isDot
                  ),
                  (0,
                  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
                    _classNames3,
                    "".concat(prefixCls, "-count-sm"),
                    size === "small"
                  ),
                  (0,
                  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
                    _classNames3,
                    "".concat(prefixCls, "-multiple-words"),
                  ...
                  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(
                    _classNames3,
                    "".concat(prefixCls, "-status-").concat(color),
                    (0, _utils__WEBPACK_IMPORTED_MODULE_8__.isPresetColor)(
                      color
                    )
                  ),
                  _classNames3)
                ...
                return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_3__.createElement(
                  _ScrollNumber__WEBPACK_IMPORTED_MODULE_9__.default,
                  {
  ...
  \*********************************************/
      /***/ function(
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ isPresetColor: function() {
            return /* binding */ isPresetColor;
          }
          /* harmony export */
        });
        /* harmony import */ var _util_colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        function isPresetColor(color) {
          return (
            _util_colors__WEBPACK_IMPORTED_MODULE_0__.PresetColorTypes.indexOf(
              color
            ) !== -1
          );
        }
