(self["webpackChunkant_design_pro"] =
  ...
  \****************************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _runtime = __webpack_require__(
          /*! @umijs/runtime */ "./node_modules/@umijs/runtime/dist/index.esm.js"
        );
        ...
        var anchorWatcher = new /*#__PURE__*/ ((function() {
          function _class2() {
            ...
            this.listener = (0, _lodash.default)(
          ...
          _createClass(_class2, [
            {
              ...
              value: function _matchActiveAnchor() {
                ...
                var closestElmIndex = this.anchors.findIndex(function(elm, i) {
                  return (
                    elm.getBoundingClientRect().top > 128 ||
                    i === _this.anchors.length - 1
                  );
                });
            ...
            },
            {
              ...
              value: function unwatch(elm) {
                this.anchors.splice(
                  this.anchors.findIndex(function(anchor) {
                    return anchor === elm;
                  }),
                  1
                );
            ...
            },
            {
              ...
              value: function unlisten(fn) {
                this.listeners.splice(
                  this.listeners.findIndex(function(f) {
                    return f === fn;
                  }),
                  1
                );
        ...
        function getElmScrollPosition(elm) {
          return (
            elm.offsetTop +
            (elm.offsetParent ? getElmScrollPosition(elm.offsetParent) : 0)
          );
        }
        ...
        var AnchorLink = function AnchorLink(props) {
          ...
          var hash =
            ((_props$to$match = props.to.match(/(#[^&?]*)/)) === null ||
            _props$to$match === void 0
              ? void 0
              : _props$to$match[1]) || "";
            ...
            if (
              ...
              ["H1", "H2", "H3"].includes(
                (_ref$current = ref.current) === null || _ref$current === void 0
                  ? void 0
                  : (_ref$current$parentEl = _ref$current.parentElement) ===
                      null || _ref$current$parentEl === void 0
                    ? void 0
                    : _ref$current$parentEl.tagName
              ) &&
      ...
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var LinkWrapper = function LinkWrapper(Component) {
          return function(_ref) {
            ...
            var hasComplexChildren = /*#__PURE__*/ _react.default.isValidElement(
              props.children
            );
                  ...
                  : {
                      ...
                      onClick: function onClick() {
                        ...
                        _props$onClick === void 0
                          ? void 0
                          : _props$onClick.apply(this, args);
                      }
                    }
              )
            );
  ...
  \*************************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _Link = __webpack_require__(
          /*! ./Link */ "./node_modules/@umijs/preset-dumi/lib/theme/components/Link.js"
        );
  ...
  \***********************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _context = _interopRequireDefault(
          __webpack_require__(
            /*! ../context */ "./node_modules/@umijs/preset-dumi/lib/theme/context.js"
          )
        );
        ...
        function getApiData(apis, identifier, locale, isDefaultLocale) {
          return Object.entries(apis[identifier]).reduce(
            (expts, [expt, rows]) => {
              expts[expt] = rows.map(props => {
                ...
                Object.keys(props).forEach(prop => {
                  ...
                  if (/^description(\.|$)/.test(prop)) {
                    ...
                    if (
                      (propLocale && propLocale !== locale) ||
                      (!propLocale && !isDefaultLocale)
                    ) {
                      delete result[prop];
                    } else {
        ...
        var _default = identifier => {
          ...
          const _useState = (0, _react().useState)(
              getApiData(apis, identifier, locale, isDefaultLocale)
            ),
            _useState2 = _slicedToArray(_useState, 2),
            data = _useState2[0],
  ...
  \***************************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        const CSB_API_ENDPOINT =
          "https://codesandbox.io/api/v1/sandboxes/define"; // ref: https://github.com/codesandbox/codesandbox-importers/blob/master/packages/import-utils/src/api/define.ts

        function serialize(data) {
          return _lzString()
            .default.compressToBase64(JSON.stringify(data))
        ...
        function getCSBData(opts) {
          ...
          const files = {};
          const deps = {};
          const CSSDeps = Object.values(opts.dependencies).filter(
            dep => dep.css
          );
            ...
            content: JSON.stringify(
              {
                name: opts.title,
                description:
                  getTextContent(opts.description) ||
...
ReactDOM.render(
  ...
  document.getElementById('root'),
          ...
          Object.entries(opts.sources).forEach(
            ([filename, { tsx, jsx, content }]) => {
  ...
  \********************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        function _copyTextToClipboard() {
          const data = _interopRequireDefault(
            __webpack_require__(
              /*! copy-text-to-clipboard */ "./node_modules/copy-text-to-clipboard/index.js"
            )
          );
  ...
  \***********************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        const getDemoUrl = (demoId, htmlSuffix) => {
          ...
          return [
            isHashRoute ? `${base}#` : origin, // compatible with (empty), /base & /base/
            `${((_window2 = window) === null || _window2 === void 0
              ? void 0
              : _window2.routerBase) || ""}/`.replace(/\/\/$/, "/"),
            getDemoRouteName(),
            "/",
            demoId,
            `${htmlSuffix ? ".html" : ""}`
          ...
          if (index < motions.length) {
            ...
            switch (type) {
              ...
              case "click":
                ...
                (_container$querySelec = container.querySelector(selector)) ===
                  null || _container$querySelec === void 0
                  ? void 0
                  : _container$querySelec.click();
                next();
                break;
              ...
              default:
                console.warn(
                  `[dumi: motion] unknown motion '${current}', skip.`
                );
                next();
            }
          } else {
      ...
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        class ColorChanger {
          ...
          constructor() {
            ...
            this.callbacks = [];
            this.color =
              localStorage.getItem(COLOR_LS_NAME) ||
              document.documentElement.getAttribute(COLOR_ATTR_NAME); // listen prefers color change
  ...
  \**********************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        const RIDDLE_API_ENDPOINT =
          "https://riddle.alibaba-inc.com/riddles/define";
        ...
        function getRiddleAppCode(opts) {
          ...
          result = result
            .replace(
              /^/,
              `import ReactDOM from 'react-dom@${((_dependencies$react =
                dependencies.react) === null || _dependencies$react === void 0
                ? void 0
                : _dependencies$react.version) || "latest"}';\n`
            )
        ...
        var _default = opts => {
          ...
          (0, _react().useEffect)(
            () => {
              if (
                opts &&
                isInternal && // TODO: riddle is not support multiple files for currently
                ...
                input.value = JSON.stringify({
                  ...
                  css: Object.entries(opts.dependencies)
                    ...
                    .map(
                      (
                        [name, { version, css }] // generate to @import '~pkg@version/path/to/css' format
                      ) =>
                        `@import '~${css.replace(
                          new RegExp(`^(${name})`),
                          `$1@${version}`
      ...
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        const useBuiltinSearch = keywords => {
                ...
                routes
                  .filter(({ title, meta }) => {
                    ...
                    const isValidDefaultLocaleRoute = // route locale euqal default locale
                      (meta === null || meta === void 0
                        ? void 0
                        : meta.locale) === locales[0].name || // missing locale and there has no locale or global locale equal default locale
                      (!(meta === null || meta === void 0
                        ? void 0
                        : meta.locale) &&
                        (!locales.length || locale === locales[0].name));
                    return (
                      title && (isValidDefaultLocaleRoute || isValidLocaleRoute)
                    );
                  })
                  .reduce((result, route) => {
                    ...
                    const routeMetaItem = {
                      title:
                        ((_route$meta = route.meta) === null ||
                        _route$meta === void 0
                          ? void 0
                          : _route$meta.title) || route.title,
                      path: route.path
                    };

                    if (
                      (_route$meta2 = route.meta) === null ||
                      _route$meta2 === void 0
                        ? void 0
                        : _route$meta2.group
                    ) {
                    ...
                    result.push(
                      ...(
                        ...
                        .filter(({ value }) => {
                          ...
                          return (
                            value !==
                            (((_route$meta4 = route.meta) === null ||
                            _route$meta4 === void 0
                              ? void 0
                              : _route$meta4.title) || route.title)
                          );
                        })
                        .map(slug => ({
                          title: slug.value,
          ...
          (0, _react().useEffect)(
            () => {
              const val =
                keywords === null || keywords === void 0
                  ? void 0
                  : keywords.trim().toUpperCase();
        ...
        const useAlgoliaSearch = () => {
          ...
          const binder = (0, _react().useCallback)(
            selector => {
              window.docsearch(
                _objectSpread(
                  {
        ...
        var _default = (locale, code) => {
          const processor = (...args) => {
            const api = /^zh|cn$/.test(args[0])
              ? API_ENDPOINTS["zh-CN"]
              : API_ENDPOINTS["en-US"];
            return `${api}?skipLibCheck=true&jsx=1#code/${_lzString().default.compressToEncodedURIComponent(
              args[1]
            )}`;
          };
  ...
  \************************************************************/
      /***/ function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _Link = _interopRequireDefault(
          __webpack_require__(
            /*! ./components/Link */ "./node_modules/@umijs/preset-dumi/lib/theme/components/Link.js"
          )
        );

        var _NavLink = _interopRequireDefault(
          __webpack_require__(
            /*! ./components/NavLink */ "./node_modules/@umijs/preset-dumi/lib/theme/components/NavLink.js"
          )
        );

        var _AnchorLink = _interopRequireDefault(
          __webpack_require__(
            /*! ./components/AnchorLink */ "./node_modules/@umijs/preset-dumi/lib/theme/components/AnchorLink.js"
          )
        );

        var _useSearch = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useSearch */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useSearch.js"
          )
        );

        var _useCopy = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useCopy */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useCopy.js"
          )
        );

        var _useRiddle = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useRiddle */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useRiddle.js"
          )
        );

        var _useMotions = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useMotions */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useMotions.js"
          )
        );

        var _useCodeSandbox = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useCodeSandbox */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useCodeSandbox.js"
          )
        );

        var _useLocaleProps = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useLocaleProps */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useLocaleProps.js"
          )
        );

        var _useDemoUrl = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useDemoUrl */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useDemoUrl.js"
          )
        );

        var _useApiData = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useApiData */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useApiData.js"
          )
        );

        var _useTSPlaygroundUrl = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/useTSPlaygroundUrl */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/useTSPlaygroundUrl.js"
          )
        );

        var _usePrefersColor = _interopRequireDefault(
          __webpack_require__(
            /*! ./hooks/usePrefersColor */ "./node_modules/@umijs/preset-dumi/lib/theme/hooks/usePrefersColor.js"
          )
        );
