(self["webpackChunkant_design_pro"] =
  ...
  \**************************************************************/
      /***/ function(
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ renderClient: function() {
            return /* binding */ renderClient;
          },
          /* harmony export */ renderRoutes: function() {
            return /* binding */ renderRoutes;
          }
          /* harmony export */
        });
        /* harmony import */ var _umijs_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! @umijs/runtime */ "./node_modules/react-router/esm/react-router.js"
        );
        /* harmony import */ var _umijs_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        /* harmony import */ var react_router_config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! react-router-config */ "./node_modules/react-router-config/esm/react-router-config.js"
        );
        ...
        function Route(props) {
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
            _umijs_runtime__WEBPACK_IMPORTED_MODULE_2__.__RouterContext
              .Consumer,
            null,
            function(context) {
              ...
              return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                ...
                newProps.match
                  ? render(
                      _objectSpread2(
                        _objectSpread2({}, props.layoutProps),
                        newProps
                      )
                    )
                  : null
              ...
              react__WEBPACK_IMPORTED_MODULE_0__.Children.forEach(
                ...
                function(child) {
                  if (
                    ...
                    match = path
                      ? (0,
                        _umijs_runtime__WEBPACK_IMPORTED_MODULE_2__.matchPath)(
                          location.pathname,
                          _objectSpread2(
                        ...
                        while (1) {
                          switch ((_context.prev = _context.next)) {
                            ...
                            case 4:
                              ...
                              preloadComponent =
                                preloadComponent.default || preloadComponent;
                            ...
                            case 6:
                              ...
                              if (
                                !((_preloadComponent = preloadComponent) ===
                                  null || _preloadComponent === void 0
                                  ? void 0
                                  : _preloadComponent.getInitialProps)
                              ) {
                                _context.next = 15;
                                break;
                              }
                              ...
                              return opts.plugin.applyPlugins({
                                ...
                                type:
                                  _umijs_runtime__WEBPACK_IMPORTED_MODULE_3__
                            ...
                            case 10:
                              ctx = _context.sent;
                              _context.next = 13;
                              return preloadComponent.getInitialProps(
                                ctx || defaultCtx
                              );
        ...
        function _render(_ref2) {
          ...
          if (Component) {
            var defaultPageInitialProps = opts.isServer
              ? {}
              : window.g_initialProps;

            var newProps = _objectSpread2(
              _objectSpread2(
                _objectSpread2(_objectSpread2({}, props), opts.extraProps),
            ...
            var ret = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              Component,
              newProps,
              routes
            ); // route.wrappers
        ...
        function getRouteElement(_ref3) {
          ...
          if (route.redirect) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              _umijs_runtime__WEBPACK_IMPORTED_MODULE_2__.Redirect,
              _extends({}, routeProps, {
                from: route.path,
                to: route.redirect
              })
            ...
            if (
              ...
              opts.ssrProps &&
              !opts.isServer && // make sure loaded once
              !((_route$component = route.component) === null ||
              _route$component === void 0
                ? void 0
                : _route$component.wrapInitialPropsLoaded) && // TODO need a type
              (((_route$component2 = route.component) === null ||
              _route$component2 === void 0
                ? void 0
                : _route$component2.getInitialProps) ||
                ((_route$component3 = route.component) === null ||
                _route$component3 === void 0
                  ? void 0
                  : _route$component3.preload))
            ) {
        ...
        function renderRoutes(opts) {
          ...
          return opts.routes
            ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                Switch,
                switchProps,
                opts.routes.map(function(route, index) {
        ...
        function RouterComponent(props) {
          ...
          (0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(
            function() {
              ...
              function routeChangeHandler(location, action) {
                var matchedRoutes = (0,
                react_router_config__WEBPACK_IMPORTED_MODULE_4__.matchRoutes)(
                  props.routes,
                  location.pathname
                ); // Set title
                ...
                if (
                  ...
                  document.title =
                    (matchedRoutes.length && // @ts-ignore
                ...
                props.plugin.applyPlugins({
                  key: "onRouteChange",
                  type:
                    _umijs_runtime__WEBPACK_IMPORTED_MODULE_3__.ApplyPluginsType
                      .event,
                  args: {
                    routes: props.routes,
          ...
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
            _umijs_runtime__WEBPACK_IMPORTED_MODULE_2__.Router,
            {
              history: history
            },
        ...
        function _preloadComponent() {
          _preloadComponent = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee(
              readyRoutes
            ) {
              var pathname,
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 11:
                        ...
                        route.component =
                          _preloadComponent2.default || _preloadComponent2;
          ...
          var rootContainer = opts.plugin.applyPlugins({
            type:
              _umijs_runtime__WEBPACK_IMPORTED_MODULE_3__.ApplyPluginsType
                .modify,
            key: "rootContainer",
            initialValue: /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              RouterComponent,
              {
            ...
            if (window.g_useSSR) {
              if (opts.dynamicImport) {
                ...
                preloadComponent(opts.routes).then(function() {
                  (0,
                  react_dom__WEBPACK_IMPORTED_MODULE_1__.hydrate)(rootContainer, rootElement, callback);
                });
              } else {
                (0, react_dom__WEBPACK_IMPORTED_MODULE_1__.hydrate)(
                  rootContainer,
                  rootElement,
                  callback
                );
              ...
              (0, react_dom__WEBPACK_IMPORTED_MODULE_1__.render)(
                rootContainer,
                rootElement,
                callback
              );
  ...
  \*********************************************************************/
      /***/ function(
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ matchRoutes: function() {
            return /* binding */ matchRoutes;
          },
          /* harmony export */ renderRoutes: function() {
            return /* binding */ renderRoutes;
          }
        ...
        function matchRoutes(
          ...
          routes.some(function(route) {
            var match = route.path
              ? (0, react_router__WEBPACK_IMPORTED_MODULE_2__.matchPath)(
                  pathname,
                  route
                )
              : branch.length
                ? branch[branch.length - 1].match // use parent match
                : react_router__WEBPACK_IMPORTED_MODULE_2__.Router.computeRootMatch(
                    pathname
            ...
            ? react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                ...
                routes.map(function(route, i) {
                  return react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                    react_router__WEBPACK_IMPORTED_MODULE_2__.Route,
                    {
                      key: route.key || i,
                      path: route.path,
                      exact: route.exact,
