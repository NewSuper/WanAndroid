            ...
            <FormItem {...formItemLayout} label="户型">
              <InputGroup compact>
                ...
                {getFieldDecorator('houseType_2', {
                  rules: [{ required: true, message: '此项为必填项' }],
                })(<Input style={{ width: '18%', marginLeft: '5px' }} addonAfter="厅" />)}
                {getFieldDecorator('houseType_3', {
                  rules: [{ required: true, message: '此项为必填项' }],
                })(<Input style={{ width: '18%', marginLeft: '5px' }} addonAfter="卫" />)}
                {getFieldDecorator('houseType_4', {
                  rules: [{ required: true, message: '此项为必填项' }],
                })(<Input style={{ width: '18%', marginLeft: '5px' }} addonAfter="厨" />)}
                {getFieldDecorator('houseType_5', {
                  rules: [{ required: true, message: '此项为必填项' }],
                })(<Input style={{ width: '23%', marginLeft: '5px' }} addonAfter="阳台" />)}
              </InputGroup>
            </FormItem>
            ...
            <FormItem {...formItemLayout} label="楼层">
              <InputGroup compact>
                {getFieldDecorator('floor_1', {
                  rules: [{ required: true, message: '此项为必填项' }],
                })(<Input style={{ width: '30%' }} addonBefore="第" addonAfter="层" />)}
